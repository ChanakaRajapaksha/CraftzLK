...
// Firebase removed - admin access is via client app (role=admin) and cookies/auth
...
const Login = () => {
  ...
  const signInWithGoogle = () => {
    context.setAlertBox({
      open: true,
      error: true,
      msg: "Google Sign-In is not used here. Sign in on the main site, then open Dashboard from your profile menu if you are an admin.",
    });
  };
