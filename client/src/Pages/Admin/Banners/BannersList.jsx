...
export default function BannersList() {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    fetchDataFromApi("/api/banners").then((res) => setSlideList(Array.isArray(res) ? res : []));
  }, []);
                ...
                <tr key={item._id || item.id}>
                  ...
                  <td>
                    <div className="actions d-flex align-items-center">
                      <Link to={`/dashboard/banners/edit/${item._id || item.id}`}>
